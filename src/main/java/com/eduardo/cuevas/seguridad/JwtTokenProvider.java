package com.eduardo.cuevas.seguridad;
...
import com.eduardo.cuevas.excepciones.CustomException;
...
public class JwtTokenProvider {
	...
	public boolean validarToken(String token) {
		try {
			...
			throw new CustomException(HttpStatus.BAD_REQUEST,"Firma JWT no valida");
		}
